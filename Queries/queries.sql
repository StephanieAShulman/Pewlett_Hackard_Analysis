...
-- Confirm tables were successfully created
...
-- Examining employees born 1952 - 1955
...
-- Need table with employee number so updating
...
-- Join to salaries and dept_emp tables
SELECT e.emp_no,
    e.first_name,
	e.last_name,
    e.gender,
...
-- 7.3.6 Tailored for Sales Team (d007)
-- SALES alone
-- employee numbers, name, dept number
SELECT e.emp_no,
    e.first_name,
	e.last_name,
    d.dept_name
